...
class KafkaMetricsTest {
    ...
    void shouldRecordSuccessfulKafkaProcessing() {
        long durationNanos = TimeUnit.MILLISECONDS.toNanos(80);
        ...
        assertThat(timer.totalTime(TimeUnit.MILLISECONDS)).isEqualTo(80.0);
    }

    @Test
    @DisplayName("should record kafka processing timer with failure outcome")
    void shouldRecordFailedKafkaProcessing() {
        long durationNanos = TimeUnit.MILLISECONDS.toNanos(35);
        ...
        assertThat(timer).isNotNull();
        assertThat(timer.count()).isEqualTo(1);
        assertThat(timer.totalTime(TimeUnit.MILLISECONDS)).isEqualTo(35.0);
    }
}
